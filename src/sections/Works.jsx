...
const projects = [
  {
    ...
    description: '전국 유기동물 보호소 데이터를 통합하고\nJWT 이중 토큰 + OAuth2 소셜 로그인으로 안전한 인증 시스템을 직접 설계했습니다.',
  ...
  },
  {
    ...
    description: 'Vite 번들 66% 감소, SSE 인증 보안 이슈 직접 해결,\nPWA로 iOS 크로스플랫폼 대응까지 — 성능과 안정성을 함께 개선했습니다.',
    role: 'Frontend · UI/UX 설계',
    year: '2026.03',
    tags: ['React', 'TypeScript', 'Python', 'OpenAI', 'RESTful API', 'PWA', 'SSE', 'Redis'],
    contributions: [
      'Vite 번들 최적화로 66% 감소 (1.8MB → 620KB)',
      'SSE 인증 구조 설계 및 보안 이슈 직접 해결',
      'Redis 기반 실시간 랭킹 시스템 연동',
      'Python & OpenAI를 활용한 개인화 건강 데이터 분석 및 조언 시스템 구현',
      'PWA 적용으로 iOS 크로스 플랫폼 대응 및 RESTful API 구축',
    ],
